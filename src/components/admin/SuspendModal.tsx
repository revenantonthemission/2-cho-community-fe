      ...
      <div className="admin-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="input-group">
            ...
            <input id="suspend-days" type="number" min={1} max={365} value={days}
              onChange={(e) => setDays(Number(e.target.value))} required />
          </div>
          <div className="input-group">
            <label htmlFor="suspend-reason">정지 사유</label>
            <textarea id="suspend-reason" value={reason}
              onChange={(e) => setReason(e.target.value)}
              placeholder="정지 사유를 입력하세요" maxLength={500} rows={3} required />
          </div>
