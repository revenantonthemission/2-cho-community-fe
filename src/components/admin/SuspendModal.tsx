...
export default function SuspendModal({ nickname, onConfirm, onClose }: Props) {
  ...
  return (
    <Modal isOpen onClose={onClose} title={`사용자 정지: ${nickname}`}>
      <form onSubmit={handleSubmit}>
        <div className="input-group">
          <label htmlFor="suspend-days" className="input-label">정지 기간 (일)</label>
        ...
        <div className="input-group">
          <label htmlFor="suspend-reason" className="input-label">정지 사유</label>
        ...
        <div className="modal-actions">
          <button type="submit" className="btn btn-danger btn-sm" disabled={isSubmitting || !reason.trim()}>
